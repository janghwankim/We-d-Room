...
<body>
	...
	String f_id = mem.findId(kakaotalk); //아이디를 디비에서 가져옴..실패시 널
	%>
	<div class="container">
		<div class="input-form-background row">
			<div class="input-form col-md-12 mx-auto">
				...
				<br>
				<br>
				<form name="idsearch" method="post" style="margin-left: 100px;">
					<%
					if (f_id != null) {
					%>
					<div class="container">
					...
					<div class="container">
						...
						<div class="col-md-8 mb-1 text-center" style="margin-left: 30px;">
							<input class="btn btn-info btn-lg" type="button" id="btnjoin"
								value="회원가입" onClick="./agreement.jsp" /> &nbsp;&nbsp;&nbsp; <input
